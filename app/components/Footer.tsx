...
const Footer = () => {
  return (
    <footer className="w-full min-h-60 p-2 flex flex-col items-center justify-center bg-black">
      <h1 className="text-center md:text-5xl text-3xl mb-2 text-white">Ready to make <span className="text-emerald-500">your</span> idea a reality?</h1>
      ...
      <div className="w-full h-[85px] flex flex-col md:flex-row justify-between items-center flex-wrap mt-5">
        ...
        <div>
          <a href="https://github.com/Taj56" target="_blank" className="relative inline-flex h-12 overflow-hidden rounded-sm-md p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
          ...
          <a href="https://www.instagram.com/kxng_sofa/" target="_blank" className="relative inline-flex h-12 overflow-hidden rounded-sm-md p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ml-1">
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
          ...
          <a href="https://www.linkedin.com/in/tajay-robertson-8ba3b8311/" target="_blank" className="relative inline-flex h-12 overflow-hidden rounded-sm-md p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 ml-1">
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
