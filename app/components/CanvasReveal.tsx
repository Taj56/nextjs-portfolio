  ...
  return (
    <>
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-black w-full gap-4 mx-auto px-8">
        <div className="bg-zinc-900 w-72 md:w-96">
            <Card title="Planning & Designing" order="Phase 1">
            <CanvasRevealEffect
                animationSpeed={5.1}
        ...
        <div className="bg-zinc-900 w-72 md:w-96">
        <Card title="Developement & Testing" order="Phase 2">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <div className="bg-zinc-900 w-72 md:w-96 sm:w-60">
        <Card title="Deployment" order="Phase 3">
          <CanvasRevealEffect
            animationSpeed={3}
    ...
    >
      ...
      <div className="relative z-20 ">
        <div className="text-center group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center ">
          <h2 className="text-emerald-500 text-3xl font-serif">{order}</h2>
        </div>
